...
MicroserviÃ§o de **comunicaÃ§Ã£o multicanal**. Gerencia envio de emails transacionais, SMS, notificaÃ§Ãµes push, chat em tempo real, templates personalizados, campanhas de marketing, integraÃ§Ã£o com sistemas de mensageria e centro de notificaÃ§Ãµes.

### ðŸŽ¯ Principais Funcionalidades

- ðŸ“§ **Email**: Templates e envio transacional
- ðŸ“± **SMS**: IntegraÃ§Ã£o Twilio/AWS SNS
- ðŸ”” **Push**: NotificaÃ§Ãµes mobile e web
- ðŸ’¬ **Chat**: Mensagens em tempo real
- ðŸ“¢ **Campanhas**: Marketing automation
- ðŸ“‹ **Templates**: GestÃ£o de modelos
- ðŸ“Š **Analytics**: MÃ©tricas de entrega
- ðŸ”— **Webhooks**: IntegraÃ§Ã£o com terceiros
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Communication;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
`
...
- **Local**: http://localhost:5008/swagger
...
curl -X GET "http://localhost:5008/api/v1/..." \
...
az webapp deploy --resource-group PAM --name PAM_MS_Communication --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Communication.ToLower() registry.azurecr.io/pam/PAM_MS_Communication.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Communication.ToLower():latest
`
...
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Communication/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_MS_Communication)**
